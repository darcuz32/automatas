...
var newCust = [[0, 5], [3, 6], [6, 8], [9, 17],[12, 4], [15, 5],[18, 14], [21, 9]];
  ...
  var plot = $.plot($('#flotLine1'),[
   ...
   update_plot5();
	...
	/**************** PIE CHART *******************/
   var piedata = [
      { label: "Series 1", data: [[1,15]], color: '#f18024'},
      { label: "Series 2", data: [[1,25]], color: '#28a745'},
      { label: "Series 3", data: [[1,85]], color: '#17a2b8'},
      { label: "Series 4", data: [[1,75]], color: '#ffc107'},
      { label: "Series 5", data: [[1,65]], color: '#dc3545'}
	 ];
