...
$(function () {
  ...
  'use strict';
	 ...
	 if ($('#monthly-revenue').length) {
      var onlineRevenueCanvas = $("#monthly-revenue").get(0).getContext("2d");
      ...
      gradient2.addColorStop(0, '#ffdcdf');
      ...
      var data = {
        ...
        datasets: [
          {
            label: 'Offline',
            data: [740, 420, 850, 580 , 740, 650, 790, 920],
            borderColor: [
              '#dc3545'
            ],
            borderWidth: 4,
          ...
          {
            label: 'Online',
            data: [740, 490, 690, 750, 920 , 1040, 880, 790],
            borderColor: [
              '#17a2b8'
            ],
            borderWidth: 4,
	...
	// daily-sales
	var dailysales = jQuery('#dailysales')
		if (dailysales.length > 0) {
			...
			document.querySelector("#dailysales"),
			options
			);
